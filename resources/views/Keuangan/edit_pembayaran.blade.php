    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="text-center bg-white pb-0">
                <h1 class="p-4">Status Pembayaran</h1>
            </div>            
                <div class="bg-white input-data-mentor">
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-personal" role="tabpanel" aria-labelledby="pills-personal-tab">
                            <form action="{{ route('pembayaran.update', ['pembayaran' => $transaksi->id]) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="mb-4">
                                ...
                                <select class="form-select" name="status" id="status" aria-label="Pilih status" required>
                                    ...
                                    <option value="Pembayaran Gagal" selected>- Pembayaran Gagal -</option>
                                    <option value="Pembayaran di terima" selected>- Pembayaran di terima -</option>
                                </select>
                            </div>
