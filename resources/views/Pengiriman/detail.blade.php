                    ...
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                ...
                                <td class="border px-6 py-4">{{ $pengiriman->transaksi->user->pelanggan->nama }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="border px-6 py-4">{{ number_format($pengiriman->transaksi->total_harga) }}</td>
                            </tr>
                            <tr>
                                <th class="border px-6 py-4 text-right">Status transaksi</th>
                                <td class="border px-6 py-4">{{ $pengiriman->transaksi->status }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="border px-6 py-4">{{ $pengiriman->transaksi->tanggal_pembelian }}</td>
                            </tr>
                            <tr>
